...
ActiveRecord::Schema.define(version: 2020_01_29_200424) do
  ...
  create_table "users_histories", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["test_id"], name: "index_users_histories_on_test_id"
  ...
  add_foreign_key "users_histories", "tests"
  add_foreign_key "users_histories", "users"
end
