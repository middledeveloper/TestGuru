...
Test.create(title: 'C#', level: 0, category_id: 1)
Test.create(title: '.Net Core', level: 1, category_id: 1)
Test.create(title: 'JavaScript', level: 0, category_id: 2)
Test.create(title: 'React', level: 1, category_id: 2)
Test.create(title: 'Angular', level: 1, category_id: 2)
